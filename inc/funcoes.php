        ...
        $i = 1;
            while($row=$get_cat->fetch()):
                echo"<tr>
                    <td>".$i++."</td>
                <td>".$row['nome']. "</td>
                <td><a href='index.php?cat&edit_cat=".$row['id_categoria']."'>Editar</a></td>
                <td><a href='index.php?cat&del_cat=".$row['id_categoria']."'>Apagar</a></td>
                </tr>";
            endwhile;
            ...
            while($row=$get_cat->fetch()):
                ...
                echo"
                    <tr>
                       ...
                       <td>".$row['nome']. "</td>
                       <td>".$row1['nome']. "</td>
                       <td><a href='index.php?subCat&edit_subCat=".$row['id_subcategoria']."'>Editar</a></td>
                       <td><a href='index.php?subCat&del_subCat=".$row['id_subcategoria']."'>Apagar</a></td>
                    </tr>";
